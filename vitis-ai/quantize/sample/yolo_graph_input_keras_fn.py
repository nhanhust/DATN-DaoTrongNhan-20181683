...
# duong dan den tap calib
calib_image_dir = "quantize/calib/images"
calib_image_list = "quantize/calib/calib.txt"
calib_batch_size = 16 #batch_size = 16 thi iter = image/batchsize = 640/16 = 40
...
def eval_input(iter, eval_image_dir, eval_image_list, class_num, eval_batch_size):
  ...
  for index in range(0, eval_batch_size):
    ...
    image = central_crop(image, 280, 210)
