...
namespace vitis 
{
  namespace ai 
  {
    ...
    struct yolo_datn 
    {
      ...
      yolo_datn();
      vitis::ai::YOLOv3Result run(const cv::Mat &image);
    ...
    yolo_datn::yolo_datn()
    {
      yolov3_model_facemask_ = vitis::ai::YOLOv3::create("dpu_yolov4_facemask",true);
    }

    vitis::ai::YOLOv3Result yolo_datn::run(const cv::Mat &image) 
    {
