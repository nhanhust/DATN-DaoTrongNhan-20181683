...
namespace vitis 
{
  namespace ai 
  {
    ...
    struct yolo_datn 
    {
      static std::unique_ptr<yolo_datn> create();
      yolo_datn();
      vitis::ai::YOLOv3Result run(const cv::Mat &input_image);
    ...
    std::unique_ptr<yolo_datn> yolo_datn::create() 
    {
      return std::unique_ptr<yolo_datn> (new yolo_datn());
    }
    ...
    yolo_datn::yolo_datn()
    {
      yolov3_model_facemask_ = vitis::ai::YOLOv3::create("dpu_yolov4_facemask");
    }

    // std::vector<vitis::ai::YOLOv3Result>
    yolo_datn::run(const cv::Mat &input_image) 
    {
      vitis::ai::YOLOv3Result mt_results;
      cv::Mat image_facemask = input_image;
      // DPU time
	    // float dpu_time = 0.0;
      ...
      mt_results = yolov3_model_facemask_results;
      return mt_results;
    }
